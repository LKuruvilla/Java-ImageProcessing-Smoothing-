...
//        imageProcess.processFile();
       ...
       // BufferedImage redrawn = 
        mThread.current = current;
        mThread.redrawn = new BufferedImage(width,height,BufferedImage.TYPE_INT_RGB);
        int division =8;
        ...
        int hstartIndex, hendIndex, wstartIndex, wendIndex;
        
        
        for (int i =0; i<division; i++)
        {  
            
            wstartIndex = i*wfactor;
            wendIndex = wstartIndex + wfactor-1;
...
//            
            ...
            {
                hstartIndex =j*hfactor;
                hendIndex = hstartIndex + hfactor-1;
                ...
                Runnable run = new mThread(wstartIndex, wendIndex, hstartIndex, hendIndex);
    ...
    public mThread(int startwidth,int width, int startheight,int height){
